...
const NewTemplate = ({ data }) => {
  ...
  return (
    ...
    <TouchableOpacity>
    <View style={{position:'relative', borderColor:'white', borderWidth:3, height:'100%', borderRadius:10, alignItems:'center'}}>
        <View style={{position:'relative',paddingTop:'15%', padding:'3%', height:'30%',alignItems:'center'}}>
            ...
            <View style={{justifyContent:'center', height:60,alignItems:'center',flexDirection:'column', flex:1}}>
                <ProgressCircle
                    ...
                    shadowColor='#555555'
                    bgColor='black'>
                    <Text style={{fontSize:30,fontWeight:'bold', color:'#99bb99'}}>
                        {data.templatescore}
                    </Text>
                </ProgressCircle>
