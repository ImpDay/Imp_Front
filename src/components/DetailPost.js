    ...
    return(
        <View style={{position:'relative',alignItems:'center',}}>
            {quesInfo.map((data, index)=> {
                return(
                    <DetailMore key={index} data={data}/>
                  )
            })}
        </View>
    )
