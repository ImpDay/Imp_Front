...
const Friends = ({data})=>{
    return(
        <View style={{position:'relative',flexDirection:'row', width:'100%', height:60, backgroundColor:'black', marginBottom:'3%', alignItems:'center'}}>
            <View style={{position:'relative',backgroundColor:'black', width:55, height:55, marginLeft:'6%', borderRadius:25, borderColor:'#555555', borderWidth:2, justifyContent:'center', alignItems:'center'}}>
                <Image
