...
const friendInfo = [
  {
    username: 'changyong',
    userImage: require('../../images/place/image1.jpeg'),
    isFollowing: true,
  },
  {
    username: 'changwan',
  ...
  {
    username: 'jihwan',
    userImage: require('../../images/place/images7.jpeg'),
    isFollowing: true,
  },
  {
    username: 'jihwan',
    userImage: require('../../images/place/images9.jpeg'),
    isFollowing: false,
  },
  {
    username: 'jihwan',
    userImage: require('../../images/place/images10.jpeg'),
    isFollowing: false,
  },
  {
    username: 'jihwan',
        ...
        <View
          ...
          <TouchableOpacity onPress={handleAddItem}>
            <View
              ...
              <Text
                style={{color: '#555555', fontWeight: 'bold', fontSize: 15}}>
                검색
              </Text>
            </View>
          </TouchableOpacity>
